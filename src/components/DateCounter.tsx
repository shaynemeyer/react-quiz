...
// Actions
type Increment = { type: 'inc' };
type Decrement = { type: 'dec' };
type SetCount = { type: 'setCount', payload: number };
type SetStep = { type: 'setStep', payload: number };
type Reset = { type: 'reset' };

type DateCounterAction = Increment | Decrement | SetCount | SetStep | Reset ;
